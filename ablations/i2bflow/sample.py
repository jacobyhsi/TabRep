...
from ablations.i2bflow.models.flow_matching import sample as cfm_sampler
from ablations.i2bflow.models.modules import MLPDiffusion, Model
from ablations.i2bflow.models.flow_matching import ConditionalFlowMatcher
...
def sample(
    ...
    d_in = np.sum(num_bits_per_cat_feature) + num_numerical_features_
    ...
    if num_samples > 500000:
        ...
        syn_data = cfm_sampler(model, num_samples, d_in, N=50, device=device, use_tqdm=True)
