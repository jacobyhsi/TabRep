...
from ablations.learnedflow_2d.models.modules import MLPDiffusion, Model
from ablations.learnedflow_2d.models.flow_matching import ConditionalFlowMatcher
    ...
    def run_loop(self):
        ...
        while step < self.steps:
            ...
            if (step + 1) % self.log_every == 0:
                ...
                # if step % 10000 == 0:
                #     cur_emb = self.model.embeddings[1].weight.detach().cpu().numpy()
                #     print(cur_emb.shape)
                ...
                #     # Saving the plot
                #     plt.savefig(f"emb_visualization_adult_3d_{step}_flow.png")
                #     exit()
